...
<meta charset="UTF-8">
<title>Accueil</title>
<link rel='stylesheet' type='text/css' href='Admin/Accueil.css'>
<style type="text/css">
...
<body>
   ...
   %>
	...
	<div class="tab-books">
       ...
       <ul>
       <li><a href="Admin/Add_bk_bb.jsp">Ajouter des livres ou categorie</a></li>
       <li><a href="Admin/getCommandes.jsp">Voir les commandes</a></li>
       <li><a href="Admin/getClients.jsp">Voir les clients</a></li>
       </ul>
